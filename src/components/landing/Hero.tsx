...
import { Phone, ArrowRight, ShieldCheck, Wind, Zap, FlaskConical, Search } from "lucide-react";
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* UNIQUE OVERLAY IMAGE: Using a smoke/mist texture overlay for 'air quality' feel */}
        <div className="absolute inset-0 opacity-30 mix-blend-screen overflow-hidden">
          <img
            ...
            alt="Air Quality Texture Overlay"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 mb-8 animate-fade-in shadow-lg shadow-indigo-500/5">
            ...
            <span className="text-sm font-bold uppercase tracking-wider">Pitman's Advanced Air Quality Specialists</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-12 border-t border-white/10 animate-fade-in-delay-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-medium">Molecular Neutralization</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-indigo-500/20 flex items-center justify-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white font-medium">Source Identification</span>
            </div>
          </div>
        </div>
      </div>
